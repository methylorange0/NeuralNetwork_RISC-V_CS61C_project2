...
class TestRelu(TestCase):
    ...
    def test_inputFail(self):
        t = AssemblyTest(self, "relu.s")
        # create an array in the data section which length == 0
        array0 = t.array([])
        # load address of `array0` into register a0
        t.input_array("a0", array0)
        # set a1 to the length of our array
        ...
        # call the relu function
        t.call("relu")
        # check that the return fail code is 78 
        t.check_scalar("a0", 78)
        # generate the `assembly/TestRelu_test_inputFail.s` file and run it through venus
        t.execute()
...
class TestArgmax(TestCase):
    ...
    def test_inputFail(self):
        ...
        # call the relu function
        t.call("argmax")
        # check that the return fail code is 77 
...
class TestDot(TestCase):
    ...
    def test_wrong_stride_without_error(self):
        t = AssemblyTest(self, "dot.s")
        # create arrays in the data section
